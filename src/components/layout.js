            ...
            <Grid.Row>
              <Grid.Column width={ 8 }>
                ...
                <p style={ { fontSize: '1.33em' } }>
                  ...
                  they never thought possible. Let us delight
        ...
        <Segment style={ { padding: '8em 0em' } } vertical>
          <Container text>
            ...
            <p style={ { fontSize: '1.33em' } }>
              ...
              generic content that can seem massive, monolithic
            ...
            <p style={ { fontSize: '1.33em' } }>
              ...
              non-sequitur filler content, but it&apos;s really
              true.
            ...
            <Grid divided inverted stackable>
              <Grid.Row>
                ...
                <Grid.Column width={ 7 }>
                  ...
                  <p>Extra space for a call to action inside the footer
